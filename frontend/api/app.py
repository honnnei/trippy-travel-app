...
class Trip(db.Model):
    ...
    def __init__(self, user_id, trip_country_code, trip_country, trip_bio, trip_length):
...
class TripSchema(ma.Schema):
    class Meta:
        fields = ('id', 'user_id','user_email', 'trip_country_code', 'trip_country', 'trip_bio', 'trip_length', 'date_created')
        # 'trip_image'
#Init schema
