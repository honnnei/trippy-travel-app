    ...
    <div className="user-profile-page-container">
      ...
      <div className="timeline-gallery-map-container">
        <div className="t-g-m-navbar">
          <Button variant="secondary" onClick={toggleMap}>
            Map
          </Button>{" "}
          <Button variant="secondary" onClick={toggleTimeline}>
            Timeline
          </Button>{" "}
          <Button variant="secondary" onClick={toggleGallery}>
            Gallery
          </Button>{" "}
          <Button variant="secondary" onClick={toggleFollowers}>
            Followers
          </Button>{" "}
          <Button variant="secondary" onClick={toggleAddTripModal}>
            Add Trip
          </Button>{" "}
        </div>
        ...
        <div className="modal">
          <Modal isOpen={modal} toggle={toggleAddTripModal}>
            <ModalHeader toggle={toggleAddTripModal}>
              Create a Trip:
            </ModalHeader>
            <ModalBody>
              <AddTripForm />
